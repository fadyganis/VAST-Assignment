...
```{r,echo=TRUE}
gps <- read.csv("_site/Methodology_files/gps.csv")
nrow(gps)
glimpse(gps)
```
...
```{r,echo=TRUE}
car <- read.csv("_site/Methodology_files/car-assignments.csv")
...
```{r,echo=TRUE}
bgmap <- raster('_site/Methodology_files/MC2-tourist.tif')
```
<p>
